...
async function main() {
    ...
    console.log(`User 1 balances: Apple ${await contractApple.balanceOf(user1.address)}, Potato: ${await contractPotato.balanceOf(user1.address)}`);
    console.log(`User 2 balances: Apple ${await contractApple.balanceOf(user2.address)}, Potato: ${await contractPotato.balanceOf(user2.address)}`);
    console.log(`User 3 balances: Apple ${await contractApple.balanceOf(user3.address)}, Potato: ${await contractPotato.balanceOf(user3.address)}`);
